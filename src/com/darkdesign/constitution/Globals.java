...
public class Globals {
	...
	public static ArrayList<DataObject> constitutionData = new ArrayList<DataObject>();
	public static ArrayList<DataObject> moreInformationData = new ArrayList<DataObject>();
	public static ArrayList<DataObject> similarDocumentsData = new ArrayList<DataObject>();
}